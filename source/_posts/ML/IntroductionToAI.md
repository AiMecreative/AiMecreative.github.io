...
# 智能化Agent: Agent架构, 理解Agent的任务, 环境, 评价标准
...
学习元件负责改进。而执行元件负责选择外部动作。

学习元件利用来自评价元件的反馈，评价Agent做得如何，并决定应该如何修改执行元件以在未来做得更好。

问题产生器负责提议可以产生新的、有启发式价值的经验的动作
